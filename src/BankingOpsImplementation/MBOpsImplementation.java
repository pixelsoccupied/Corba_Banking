...
public class MBOpsImplementation extends BankingOperationsPOA implements Runnable{
    ...
    public synchronized boolean createAccountRecord(String firstName, String lastName, String address, String phone, String branch) {
        ...
        if (noErrorCount > 0) {
            ...
            try {
                ...
                generateLogFileServer(msg, "Server" , "MBServer");
            } catch (IOException e) {
                e.printStackTrace();
            }
    ...
    public synchronized String[] getAccountCount() {
        ...
        allBranchCount.put("MB", hashArraylistSize());
