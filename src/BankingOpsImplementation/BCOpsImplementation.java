...
public class BCOpsImplementation extends BankingOperationsPOA implements Runnable{
...
*/
    ...
    public void run() {
        ...
        */
        switch (name) {
            case "MB":
                serverCount(serverPort.get("MB"), "MB");
                break;
            case "QC":
                serverCount(serverPort.get("QC"), "QC");
                break;
            default:
                serverCount(serverPort.get("NB"), "NB");
                break;
        }
