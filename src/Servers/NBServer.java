...
import BankingOpsImplementation.NBOpsImplementation;
...
public class NBServer{
    ...
    private NBOpsImplementation nbOpsImplementation = new NBOpsImplementation();
    ...
    public static void main(String args[]) {
        ...
        Thread t1 = new Thread(() -> nbServer.startCorba());
        Thread t2 = new Thread(() -> nbServer.startUDP());
    ...
    private void startUDP() {
        ...
        System.out.println("NB Server's UDP ready and waiting ...");
        ...
        while (true) {
            ...
            switch (switchTo){
                ...
                case 0:
                    ...
                    break;
                case 1:
                    boolean isTransferred = nbOpsImplementation.deposit(result[1], Double.parseDouble(result[2]));
                    if(isTransferred) {
    ...
    private void startCorba() {
        ...
        try{
            ...
            nbOpsImplementation.setORB(orb);

            // get object reference from the servant
            org.omg.CORBA.Object ref = rootpoa.servant_to_reference(nbOpsImplementation);
            ...
            NameComponent path[] = ncRef.to_name( "NB" );
            ncRef.rebind(path, href);

            System.out.println("NB Server ready and waiting ...");
